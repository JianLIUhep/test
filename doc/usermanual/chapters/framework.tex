...
\centering
  ...
  Sensor rotations around the cylinder are possible (see the parameter \protect\parameter{rotate_by} in Sec.~\ref{sssec:cylindrical_coord_system_params}). Here, the sensor is rotated clockwise from the default coordinate system by half a sensor length.}
