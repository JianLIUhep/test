...
\begin{itemize}
    ...
    \item The \parameter{flat_part} parameter is used for sensors bent along the row direction and specifies if a part of the sensor is flat (and the rest bent). For a sensor bent along the column direction this parameter can be omitted, as it will be set to 0. 
