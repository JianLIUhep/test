...
namespace corryvreckan {
    ...
    public:
         ...
         */
        virtual XYVector getSpatialResolution([[maybe_unused]] double column = 0,
                                              [[maybe_unused]] double row = 0) const override {
         ...
         */
        virtual TMatrixD getSpatialResolutionMatrixGlobal([[maybe_unused]] double column = 0,
                                                          [[maybe_unused]] double row = 0) override {
